package gsq.booker.sys.controller.common;
...
public class CommonController {
    ...
    public void mallKaptcha(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        // 验证码存入session
        httpServletRequest.getSession().setAttribute(Constants.SYS_VERIFY_CODE_KEY, captcha.text().toLowerCase());
